          ...
          {post.isImage ? (
            <img
              ...
              onError={(e) => {
                ...
                if (post.thumbnailUrl && post.thumbnailUrl !== "self" && post.thumbnailUrl !== "default") {
                  ...
                  (e.target as HTMLImageElement).src = getProxiedUrl(post.thumbnailUrl);
                } else {
                  setIsImageLoading(false);
                }
              }}
            ...
            <video
              ...
              onError={(e) => {
                ...
                // Try thumbnail as fallback for video
                if (post.thumbnailUrl && post.thumbnailUrl !== "self" && post.thumbnailUrl !== "default") {
                  console.log("Video failed, displaying thumbnail instead:", post.thumbnailUrl);
                  const imgElement = document.createElement("img");
                  imgElement.src = getProxiedUrl(post.thumbnailUrl);
                  imgElement.alt = post.title;
                  imgElement.className = "max-w-full max-h-full";
                  imgElement.onload = handleImageLoad;
                  
                  const videoParent = e.target as HTMLVideoElement;
                  if (videoParent.parentNode) {
                    videoParent.parentNode.replaceChild(imgElement, videoParent);
                  }
                } else {
                  setIsImageLoading(false);
                }
