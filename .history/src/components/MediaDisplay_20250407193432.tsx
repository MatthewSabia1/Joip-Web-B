        ...
        <div className={cn("h-full w-full flex items-center justify-center", getTransitionClasses())}>
          ...
          {post.isVideo && post.videoUrl ? (
            <>
              ...
              {console.log(`[MediaDisplay Render ${post.id}] Attempting VIDEO: ${getProxiedUrl(post.videoUrl)} (Direct: ${post.videoUrl})`)}
              <video
                key={post.id + '-video'}
          ...
          : post.isImage && post.url ? (
            <>
              {/* Log the URL being used */}
              {console.log(`[MediaDisplay Render ${post.id}] Attempting IMAGE: ${getProxiedUrl(post.url)} (Direct: ${post.url})`)}
              <img
                key={post.id + '-image'}
          ...
          : post.thumbnailUrl ? (
             <>
               {/* Log the URL being used */}
               {console.log(`[MediaDisplay Render ${post.id}] Attempting THUMBNAIL: ${getProxiedUrl(post.thumbnailUrl)} (Direct: ${post.thumbnailUrl})`)}
               <img
