...
function MainApp() {
  ...
  useEffect(() => {
    ...
    if (authState.isAuthenticated) {
      console.log('[MainApp] User is authenticated with Reddit');
      console.log('[MainApp] Access token:', authState.accessToken?.substring(0, 10) + '...');
      console.log('[MainApp] Token expires at:', new Date(authState.expiresAt || 0).toLocaleString());
    } else {
      console.log('[MainApp] User is NOT authenticated with Reddit');
    }
