...
export function MediaDisplay({
  ...
  const getTransitionClasses = () => {
    ...
    const transitions = {
      fade: {
        base: 'transition-opacity duration-400 ease-in-out will-change-opacity',
        enter: 'opacity-100',
        exit: 'opacity-0',
      },
      slide: {
        base: `${baseClasses} transition-all duration-500`,
      ...
      zoom: {
        base: `${baseClasses} transition-all duration-400 ease-out origin-center will-change-transform will-change-opacity`,
        enter: 'scale-100 opacity-100',
        exit: 'scale-50 opacity-0',
      },
      flip: {
        base: `${baseClasses} transition-all duration-600 ease-in-out transform-gpu backface-visibility-hidden perspective-1200 will-change-transform will-change-opacity`,
    ...
    <div className="relative h-full flex flex-col">
      ...
      <div className="h-12 flex items-center justify-between px-4 mt-auto">
        <Button
          ...
          size="icon"
          onClick={onPrevious}
          disabled={totalPosts <= 1 || isTransitioning}
